...
@WebListener
public class DbConnectionListener implements ServletContextListener {    //구현

    @Override
    public void contextInitialized(ServletContextEvent sce) {
        // web.xml에서 context-param 지정한 값을 불러오기
        String dbUrl = sce.getServletContext().getInitParameter("DB_URL");
        String dbUser = sce.getServletContext().getInitParameter("DB_USER");
        String dbPassword = sce.getServletContext().getInitParameter("DB_PASSWORD"); //command option v
